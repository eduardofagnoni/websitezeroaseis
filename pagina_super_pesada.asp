        ...
        <div id="conteudo">
            ...
            <header>
                ...
                <div id="menu-principal-topo" class="menu-principal">
                    <div class="container">
                        <div style="float:left">
                            <img id="logo-zero-a-seis-header" onclick="location.href='default.asp'" class="logo-normal" src="images/logo-zero-a-seis.png" alt="Instituto Zero a Seis" title="Instituto Zero a Seis" />
                        </div>
                        ...
                        <nav id="nav-menu-principal" class="nav-normal">
                            <ul class="menu">
                                <li><a href="pagina_super_pesada.asp" id="o-instituto-link">O instituto</a></li>
                                <li><a href="" id="primeira-infancia-link">1ª infância</a></li>
                                <li><a href="" id="projetos-link">Projetos</a></li>
                                <li><a href="" id="blog-link">Blog</a></li>
                                <li><a href="" id="seja-parceiro-link">Seja parceiro</a></li>
                                <li><a href="" id="contato-link">Contato</a></li>
                                <li><a href="" id="doe-link">Doe</a></li>
                            </ul>
                            <ul class="linguagem">
                ...
                <nav id="nav-menu-sobreposto" class="menu-sobreposto">
                    ...
                    <ul class="menu">
                        <li id="id-o-instituto"><a href="" id="o-instituto-link">O instituto</a></li>
                        <li id="id-primeira-infancia"><a href="" id="primeira-infancia-link">1ª infância</a></li>
                        <li id="id-projetos"><a href="" id="projetos-link">Projetos</a></li>
                        <li id="id-blog"><a href="" id="blog-link">Blog</a></li>
                        <li id="id-seja-parceiro"><a href="" id="seja-parceiro-link">Seja parceiro</a></li>
                        <li id="id-contato"><a href="" id="contato-link">Contato</a></li>
                        <li id="id-doe"><a href="" id="doe-link">Doe</a></li>
                    </ul>
                    <ul class="linguagem">
                        <li id="linguagem-pt-br" class="active"><a href="javascript:void(0)" id="portugues-link">Por <i class="fa fa-chevron-down"></i></a></li>
                        <li id="linguagem-eng" class="desactive"><a href="javascript:void(0)" id="ingles-link">Eng <i class="fa fa-chevron-down"></i></a></li>
            ...
            <div>
            <img src="images/01_instituto.png" alt="" >
                <br>
                <img src="images/imgteste1.gif">
                <br>
                <img src="images/imgteste2.gif">
                <br>
                <img src="images/imgteste3.gif">
                <br>
                <img src="images/imgteste4.png">
                <br>
                <img src="images/imgteste5.gif">
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-4 col-xs-12">
                            <a href="" id="logo-instituto-rodape"><img src="images/logo-zero-a-seis-footer.jpg" alt="Instituto Zero a Seis" title="Instituto Zero a Seis"></a>
