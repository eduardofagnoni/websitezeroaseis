...
arrListaComponentes(20) = Array( "CDONTS","CDONTS.NewMail" )
...
arrListaComponentes(48) = Array( "Cdosys Mail", "CDO.Message" )
arrListaComponentes(49) = Array( "Cdosys SMTP", "CDO.Configuration" )
...
Response.Write "<p><center>Componentes Instalados no Servidor</center></p>"
