<header class="main-header">
    ...
    <span class="logo-mini"><img src="images/logo-zero-a-seis.png" style="height:50px;" alt="Norsal" title="Norsal"></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><img src="images/logo-zero-a-seis.png" style="height:50px;" alt="Norsal" title="Norsal"></span>
    </a>
