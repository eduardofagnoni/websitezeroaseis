...
<div id="preloader">
    ...
    <canvas id="canvasbg" width="1950px" height="800px"></canvas>
        ...
        <div id="conteudo">
            ...
            <div class="banner-interno" id="banner-interno-primeira-infancia" style="background: url(images/primeira-infancia-banner-topo.jpg) no-repeat top right ; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; min-height: 600px; ">
                <div class="container">                
