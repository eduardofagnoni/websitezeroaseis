                ...
                <div id="menu-principal-topo" class="menu-principal">
                    <div class="container">
                        <div style="float:left">
                            <img id="logo-zero-a-seis-header" class="logo-normal" src="images/logo-zero-a-seis.png" alt="Instituto Zero a Seis" title="Instituto Zero a Seis" />
                        </div>
                        ...
                        <nav id="nav-menu-principal" class="nav-normal">
                            <ul class="menu">
                                <li><a href="" id="o-instituto-link">O instituto</a></li>
